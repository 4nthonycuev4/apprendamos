  ...
  return Let(
    {
      ...
      status: If(Equals(Var("authorRef"), Var("viewerRef")), "done", Abort("It is forbidden to delete other user's publication.")),
      ...
      author: Update(
        Var("authorRef"),
        {
          data: {
            stats: {
              publicationCount: {
                [ref.collection]: Add(Select(["data", "stats", "publicationCount", ref.collection], Get(Var("authorRef"))), -1),
              }
            }
          }
        },
